...
foreach($data as $line){
     ...
     $x_name = "http://www.meteor.iastate.edu/~ckarsten/bufkit/image_loader.phtml?site=".$site_l."";
     $load = "Visualize Data!";
	...
	$ewrf_l2 = "http://wrfensemble.wdtb.noaa.gov/12/ewrf_".$ewrf.".buz";
     ...
     if($site_gfs != "---"){
        ...
        $gfs_l = "http://www.meteor.iastate.edu/~ckarsten/bufkit/data/gfs/gfs3_".$site_l.".buf";
        $gfsm_l = "http://www.meteor.iastate.edu/~ckarsten/bufkit/data/gfsm/gfs3_".$site_l.".buf";
        $gfs_cobb = "http://www.meteor.iastate.edu/~ckarsten/cobb/cobb.php?model=gfs&site=".$site_l."";
        $gfsm_cobb = "http://www.meteor.iastate.edu/~ckarsten/cobb/cobb.php?model=gfsm&site=".$site_l."";
	$view_gfs_cobb = "View Cobb Output!";
     ...
     if($site_nam != "---"){
     	...
     	$nam_l = "http://www.meteor.iastate.edu/~ckarsten/bufkit/data/nam/nam_".$site_l.".buf";
     	$namm_l = "http://www.meteor.iastate.edu/~ckarsten/bufkit/data/namm/namm_".$site_l.".buf";
     	$nam_cobb = "http://www.meteor.iastate.edu/~ckarsten/cobb/cobb.php?model=nam&site=".$site_l."";
     	$namm_cobb = "http://www.meteor.iastate.edu/~ckarsten/cobb/cobb.php?model=namm&site=".$site_l."";
     ...
     if($site_rap != "---"){
     	$rap = "http://www.meteor.iastate.edu/~ckarsten/bufkit/data/rap/rap_".$site.".buf";
     	$rap_l = "http://www.meteor.iastate.edu/~ckarsten/bufkit/data/rap/rap_".$site_l.".buf";
	$rap_cobb = "";
        $rap_i = $rap_i_orig;
     }
     else{
     ...
     if($site_sref != "---"){ 
        $sref = "http://www.meteor.iastate.edu/~ckarsten/bufkit/data/sref/sref_".$site.".buz";
        $sref_l = "http://www.meteor.iastate.edu/~ckarsten/bufkit/data/sref/sref_".$site_l.".buz";
     ...
     $st41 = "\"srname\":\"".$sref."\",\"sref_l\":\"".$sref_l."\",\"sref_i\":\"".$sref_i."\",";
