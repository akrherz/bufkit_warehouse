...
$link4_5 = "&product=time-series&begin=".$init_time."%3A00%3A00&end=".$end_time."%3A00%3A00&Unit=e&dew=dew&Submit=Submit";
...
$graph->title->Set("".$site_upper_case." - Hourly Dewpoint Forecast");
//$graph->xaxis->SetTitle('Hour','center');
$graph->yaxis->title->Set("Dewpoint (F)");
