...
$bar1 = new LinePlot($store_rain);
$bar1->SetColor('forestgreen');
$bar1->SetLegend("RA");
$bar1->SetWeight(2);

$bar2 = new LinePlot($store_frz_rain);
$bar2->SetColor('red');
$bar2->SetLegend("ZR");
$bar2->SetWeight(2);     

$bar3 = new LinePlot($store_sleet);
$bar3->SetColor('orange');
$bar3->SetLegend("IP");
$bar3->SetWeight(2);     

$bar4 = new LinePlot($store_snow);
$bar4->SetColor('blue');
$bar4->SetLegend("SN");
$bar4->SetWeight(2);     
