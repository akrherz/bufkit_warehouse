...
for($z=0;$z<=4;$z++){
	...
	if($date == ""){
	        $link = "http://www.meteor.iastate.edu/~ckarsten/bufkit/data/parser.php?model=".$mdl."&site=".$site_l."&hgt=".$hgt."&ratio=".$ratio;
	}
	else{
                $link = "http://www.meteor.iastate.edu/~ckarsten/bufkit/data/parser.php?model=".$mdl."&site=".$site_l."&hgt=".$hgt."&date=".$parse_date."&ratio=".$ratio;
	}
        $temp_maxt = 0;
        $temp_sr = 0;
        $data = file($link);
