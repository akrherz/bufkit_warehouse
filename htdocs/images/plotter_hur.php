...
if($var1 == "snow_accum"){
	if($nam == 1 && $cobb == 1 && !empty($nam_var2) && !empty($nam_cobb_time) && count($nam_var2) == count($nam_cobb_time)){
		...
		if($var1 == "wind"){
			...
			if($var2 == "pmsl"){
				$lineplot_nam3=new LinePlot($nam_var3,$buf_t_nam);
                		$lineplot_nam3->SetColor("deeppink");
                		$lineplot_nam3->SetWeight(3);
                		$lineplot_nam3->SetStyle("dashed");
				$lineplot_nam3->SetLegend("".$buf_nam_init."z NAM PMSL");
				$graph->Add($lineplot_nam3);
			}
		}
		else{
...
if($var1 == "snow_accum"){
        ...
        if($namm == 1 && !empty($namm_var2) && !empty($buf_t_namm) && count($namm_var2) == count($buf_t_namm)){
                ...
                if($var1 == "wind"){
                        ...
                        if($var2 == "pmsl"){
                                $lineplot_namm3=new LinePlot($namm_var3,$buf_t_namm);
                                $lineplot_namm3->SetColor("deeppink");
                                $lineplot_namm3->SetWeight(3);
                                $lineplot_namm3->SetStyle("dashed");
                                $lineplot_namm3->SetLegend("".$buf_namm_init."z NAM PMSL");
                                $graph->Add($lineplot_namm3);
                        }
                }
                else{
...
if($var1 == "snow_accum"){
        ...
        if($gfs == 1 && !empty($gfs_var2) && !empty($buf_t_gfs) && count($gfs_var2) == count($buf_t_gfs)){
                ...
                if($var1 == "wind"){
                        ...
                        if($var2 == "pmsl"){
                                $lineplot_gfs3=new LinePlot($gfs_var3,$buf_t_gfs);
                                $lineplot_gfs3->SetColor("deeppink");
                                $lineplot_gfs3->SetWeight(3);
                                $lineplot_gfs3->SetStyle("dashed");
                                $lineplot_gfs3->SetLegend("".$buf_gfs_init."z GFS PMSL");
                                $graph->Add($lineplot_gfs3);
                        }
                }
                else{
        ...
        if($gfsm == 1 && !empty($gfsm_var2) && !empty($buf_t_gfsm) && count($gfsm_var2) == count($buf_t_gfsm)){
                ...
                if($var1 == "wind"){
	                ...
	                if($max_mt == 1){
                        ...
                        if($var2 == "pmsl"){
                                $lineplot_gfsm3=new LinePlot($gfsm_var3,$buf_t_gfsm);
                                $lineplot_gfsm3->SetColor("deeppink");
                                $lineplot_gfsm3->SetWeight(3);
                                $lineplot_gfsm3->SetStyle("dashed");
                                $lineplot_gfsm3->SetLegend("".$buf_gfsm_init."z GFS PMSL");
                                $graph->Add($lineplot_gfsm3);
                        }
                }
                else{
...
if($rap == 1 && !empty($rap_var2) && !empty($buf_t_rap) && count($rap_var2) == count($buf_t_rap)){
		...
		if($max_mt == 1){
                ...
                if($var2 == "pmsl"){
                        $lineplot_rap3=new LinePlot($rap_var3,$buf_t_rap);
                        $lineplot_rap3->SetColor("deeppink");
                        $lineplot_rap3->SetWeight(3);
                        $lineplot_rap3->SetStyle("dashed");
			if($date >= 2012050100 || $date == ""){
                        	$lineplot_rap3->SetLegend("".$buf_rap_init."z RAP PMSL");
                        }
			else{
				$lineplot_rap3->SetLegend("".$buf_rap_init."z RUC PMSL");
			}
			$graph->Add($lineplot_rap3);
                }
