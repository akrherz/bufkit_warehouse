			...
			$h++;
				...
				elseif($var1 == "wind"){
					...
					$nam_vwnd[] = $d[$vwnd_index];
                		...
                		if($h2 == 0){
	                       	        $buf_nam_init = date("H",strtotime($d[68]));
					$nam_init = strtotime($d[68]);
                       		}
                        }
                        elseif($z == 1){
                                if($var1 == "snow_accum"){
					...
					if($d[$index2] == 0){
						...
						$namm_var2[] = $d[$index2] * 1.15077945;
                                ...
                                if($h2 == 0){
                                       	$buf_namm_init = date("H",strtotime($d[68]));
					$namm_init = strtotime($d[68]);
                               	}
                        }
                       	elseif($z == 2 && $var != "hlcy"){
                                if($var1 == "snow_accum"){
					$snow[] = $d[$index];
						...
						if($ratio != 0){
                                ...
                                elseif($var1 == "wind"){
                               	...
                               	if($h2 == 0){
                                       	$buf_gfs_init = date("H",strtotime($d[68]));
					$gfs_init = strtotime($d[68]);
                               	}
                        }
                       	elseif($z == 3 && $var != "hlcy"){
                                if($var1 == "snow_accum"){
					$snow[] = $d[$index];
						...
						if($ratio != 0){
                                ...
                                if($h2 == 0){
                                       	$buf_gfsm_init = date("H",strtotime($d[68]));
					$gfsm_init = strtotime($d[68]);
                               	}
                        }
                       	elseif($z == 4){
                                if($var1 == "snow_accum"){
					$snow[] = $d[$index];
						...
						if($ratio != 0){
                                ...
                                elseif($var1 == "wind"){
                               	...
                               	if($h2 == 0){
                                       	$buf_rap_init = date("H",strtotime($d[68]));
					$rap_init = strtotime($d[68]);
                               	}
                       	}
			if($z == 5){
                                if($var1 == "snow_accum"){
				...
				if($h2 == 0){
                                        $buf_nam4km_init = date("H",strtotime($d[68]));
                                        $nam4km_init = strtotime($d[68]);
                                }
			}
                }
        }
