...
foreach($data as $line){
     ...
     if(@$cobb[11] == $hr_count){
          $pop_count_ruc++;
          $snow = explode("|",trim($line));
          $snowfall_ruc[$pop_count_ruc] = trim($snow[1]);
          $snow_ruc[$pop_count_ruc] = array_sum($snowfall_ruc);
          $make_t = "20".$cobb[0]."".$cobb[1]."-".$cobb[2]."".$cobb[3]."-".$cobb[4]."".$cobb[5]." ".$cobb[7]."".$cobb[8].":".$cobb[9]."".$cobb[10]."";
          $hr_snow_ruc[$pop_count_ruc] = strtotime($make_t);
          $ruc_init = date('H',$hr_snow_ruc[0] - 3600);
     }
}
