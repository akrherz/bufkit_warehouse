...
foreach ($data as $line) {
     ...
     if ($check1==$h_l){
          ...
          echo "$t24,$t36,$t48,$t60,$t72,$t84,$t96,$t108,$t120,$t132,$t144,$t156,$t168,$t180,$t192\n";
...
echo "$ave1,$ave2,$ave3,$ave4,$ave5,$ave6,$ave7,$ave8,$ave9,$ave10,$ave11,$ave12,$ave13,$ave14,$ave15\n";
...
echo "$std24u,$std36u,$std48u,$std60u,$std72u,$std84u,$std96u,$std108u,$std120u,$std132u,$std144u,$std156u,$std168u,$std180u,$std192u\n";
echo "$std24l,$std36l,$std48l,$std60l,$std72l,$std84l,$std96l,$std108l,$std120l,$std132l,$std144l,$std156l,$std168l,$std180l,$std192l\n";
